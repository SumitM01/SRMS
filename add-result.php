                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <div class="align-items-center mb-3 pb-1">
                                    ...
                                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing:1px;">Provide result details to add result</h5>

                                    <form action="add-result-backend.php" method="post">
                                        <!-- <div class="form-outline mb-4">
                                            <input type="text" class="form-control" placeholder="Enter Class Id" name="id">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <label for="subjectid">Marks</label>
                                        </div>
