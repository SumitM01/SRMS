                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="validateAdmin.php" method="post">
                                        ...
                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing:1px;">Provide details to login as Admin</h5> 
                                        <?php
                                        // echo $_SESSION['signin'];
                                        // echo $_SESSION['signin'] == "false";
                                        // echo isset($_SESSION['signin']);
                                        // $_SESSION['signin'] = "";
                                        ...
                                        <input type="text" class="form-control" id="adminId" name="id" aria-describedby="emailHelp">
                                        ...
                                        <input type="submit" class="btn btn-dark btn-lg btn-block" type="button" value="Login">
